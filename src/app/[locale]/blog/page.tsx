...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    path: "/blog",
    title:
      locale === "ar" ? "المدونة | نصائح واستثمار عقاري" : "Blog | Real Estate Tips and Market Insights",
    description:
      locale === "ar"
    ...
    <>
      ...
      <section className="container-shell py-18">
        <SectionHeading
          ...
          description={
            locale === "ar"
              ? "استخدم هذه المقالات كنقطة بداية قبل التواصل مع مستشارك العقاري."
              : "Use these articles as a starting point before speaking to your advisor."
          }
        />
            ...
            <article key={post.slug} className="luxury-surface overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between gap-4 text-xs uppercase tracking-[0.25em] text-[var(--color-gold)]">
                  ...
                  <span>{pickLocale(post.readTime, locale)}</span>
                </div>
